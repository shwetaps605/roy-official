...
const Cover = ({text, children}:{text?:string, children?: React.ReactNode}) => {
  return (
    <div className='group max-w-[75%] mx-auto relative bg-blue-950 hover:bg-opacity-30 bg-opacity-20 py-3 hover:cursor-default flex justify-center items-center align-middle'>
        {text && <h1 className='text-amber-300 text-7xl'>{text}</h1>}
        {children}
